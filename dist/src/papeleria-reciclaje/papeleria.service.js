...
exports.PapeleriaService = void 0;
const common_1 = require("@nestjs/common");
const db_service_1 = require("../databases/db.service");
let PapeleriaService = class PapeleriaService {
    constructor(db) {
        this.db = db;
    }
    ...
    async deleteArticlePermanent(id) {
...
PapeleriaService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [db_service_1.DbService])
], PapeleriaService);
exports.PapeleriaService = PapeleriaService;
//# sourceMappingURL=papeleria.service.js.map